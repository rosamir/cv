...
def main():
    ...
    family = [
        ...
        ("אני", "כתבתי מספיק על עצמי"),
        ("ליבי", "ליבי ״הבן״, בן 10 - הצעיר שלנו, ששומר גם אותנו צעירים."),
