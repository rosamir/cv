...
const CV_DATA = {
  personal: {
    ...
    title: "מנהל בכיר המחבר בין עסק, טכנולוגיה, דאטה ואנשים | הובלת חדשנות, טרנספורמציה דיגיטלית ו-AI - מגיבוש אסטרטגיה עסקית וטכנולוגית דרך יישום בפועל והובלת שינוי ארגוני ועד אימוץ והשפעה עסקית",
    ...
    personalStory: {
      ...
      paragraphs: [
        "מעבר לטכנולוגיות פורצות דרך, ארכיטקטורות ענן וסוכני AI – בבסיס של כל הצלחה עסקית עומדים אנשים, ערכים ואמון. אני מנהל עם גישה אנושית בגובה העיניים, חיבור עמוק לצוותים, העצמת מנהלים ויצירת סביבה שבה חדשנות ויצירתיות יכולות לשגשג.",
