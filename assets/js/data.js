...
const CV_DATA = {
  personal: {
    ...
    title: "Chief AI Officer (CAIO) | מנהיג טכנולוגיה, חדשנות וטרנספורמציה דיגיטלית",
    tagline: "מנהל בכיר בעל ראייה אסטרטגית רחבה, מומחיות עמוקה ב-AI, ענן, דיגיטל ו-Omnichannel, וניסיון מוכח בהובלת שינויים ארגוניים מורכבים וחיבור ישיר בין טכנולוגיה מתקדמת לערך עסקי וצמיחה.",
    phone: "054-2435566",
    ...
    personalStory: {
      ...
      paragraphs: [
        "מעבר לטכנולוגיות פורצות דרך, ארכיטקטורות ענן וסוכני AI – בבסיס של כל הצלחה עסקית עומדים אנשים, ערכים ואמון. המנהיגות שלי נשענת על גישה אנושית בגובה העיניים, חיבור עמוק לצוותים, העצמת מנהלים ויצירת סביבה שבה חדשנות ויצירתיות יכולות לשגשג.",
        "העוגן המשמעותי והחשוב ביותר בחיי הוא המשפחה שלי. הם מקור ההשראה, הכוח והאיזון שלי שמאפשר לי להוביל מהלכים בקנה מידה לאומי, לקבל החלטות אסטרטגיות מורכבות תחת לחץ ולשמור תמיד על חדות, חום אנושי ואופטימיות.",
        "במקביל לעשייה הניהולית והטכנולוגית, אני רואה שליחות גדולה בהעברת ידע וטיפוח דור העתיד – כמרצה למדעי המחשב בעברי וכמנטור ושופט בבית הספר ליזמות של אוניברסיטת רייכמן מזה למעלה מעשור."
      ],
      values: [
        { title: "מנהיגות מעצימה & Integrity", desc: "הובלה מתוך דוגמה אישית, שקיפות מלאה, אמון והצבת רף מקצועי בלתי מתפשר.", icon: "shield-check" },
        { title: "סקרנות & חדשנות מתמדת", desc: "למידה בלתי פוסקת של טכנולוגיות קצה (GenAI, Agentic AI, Cloud) ותרגומן ליתרון תחרותי.", icon: "zap" },
        { title: "מיקוד בערך עסקי וחוויית לקוח", desc: "טכנולוגיה היא אמצעי להשגת יעדים עסקיים, שיפור ביצועים והענקת חוויה מעולה ללקוח.", icon: "target" },
        { title: "נתינה וטיפוח דור העתיד", desc: "הדרכה, מנטורינג וחיבור בין האקדמיה, הסטארטאפים והתעשייה המסורתית.", icon: "heart-handshake" }
      ]
    }
  },
  ...
  experience: [
    {
      ...
      shortSummary: "הקמה והובלה של מרכז ה-AI של בנק לאומי, גיבוש אסטרטגיית AI ארגונית הוליסטית, הקמת AI Board בראשות המנכ״ל, והובלת טרנספורמציית Generative & Agentic AI בכלל זרועות הבנק שהובילה לדירוג לאומי במקום ה-1 בישראל באימוץ AI (מדד Evident AI).",
      bullets: [
        ...
        "יצירת השפעה עסקית ותפעולית מדידה: פריסת צ׳אט AI לכלל לקוחות הבנק בדיגיטל עם ירידה של כ-10% בפניות הכתובות לבנקאי ללא עלייה בהיקף השיחות למוקד; פתרונות תמלול ו-AI שהביאו לקיצור של כ-15%-20% בזמני טיפול ולירידה של כ-95% בשגיאות תיעוד; והובלת AI-Driven SDLC עם יעד של לפחות 20% שיפור בפרודוקטיביות.",
...

    {
      ...
      badge: "דירקטוריון",
      category: "finance",
      shortSummary: "כהונה כדירקטור במס״ב - מרכז סליקה בנקאי, לצד תפקידי הניהול הבכירים בבנק לאומי.",
      bullets: [
        "דירקטור במס״ב - מרכז סליקה בנקאי, בשנים 2024-2026."
      ],
...

    {
      id: "leumi-channels",
      period: "2023 - 2025",
      role: "ראש אגף ערוצים, טכנולוגיות שוקי הון וטכנולוגיות רוחביות",
      company: "בנק לאומי",
      companyType: "בנקאות וטכנולוגיות ליבה",
      badge: "הנהלה בכירה | אגף טכנולוגי רחב",
      category: "banking",
      shortSummary: "ניהול אגף טכנולוגי רחב ואחריות End-to-End על Product, Technology & Delivery בתחומי ה-Omnichannel, Salesforce Enterprise, טכנולוגיות שוקי הון (אפליקציית Trade), Contact Center מודרני (CCaaS), ומערך השירותים האוטומטיים.",
      bullets: [
        "ניהול אגף טכנולוגי רחב ואחריות End-to-End על Product, Technology & Delivery בתחומים אסטרטגיים בבנק: מערך הערוצים והרב-ערוציות, Salesforce, טכנולוגיות שוקי הון ופלטפורמות טכנולוגיות רוחביות.",
        ...
        "הובלת מהלך אסטרטגי למודרניזציה של ה-Contact Center, לרבות גיבוש תפיסת היעד והארכיטקטורה והובלת RFP להחלפת הפלטפורמה הקיימת בפתרון CCaaS, משלב הגדרת הדרישות ובחינת החלופות ועד להיערכות למימוש.",
        ...
        "ניהול פורטפוליו של פלטפורמות וטכנולוגיות רוחביות המשרתות חטיבות ותהליכים רבים בבנק, ובהן מערכות BPM וניהול תהליכים, מערכות כגון FreeForm ו-Docomotion, כלי תיוק וארכיון, ומערכת לניהול הודעות ללקוחות בערוצים השונים והחוקה.",
...

    {
      ...
      category: "vc",
      shortSummary: "ניהול כולל של חטיבת הטכנולוגיות וקרן ההון סיכון התאגידית (Irani Ventures), חבר בדירקטוריון המצומצם של הקבוצה, הובלת השקעות בסטארטאפים בתחום ה-Retail Tech, יצירת סינרגיות עסקיות ועבודה מול C-Level של מותגי יוקרה בינלאומיים.",
      bullets: [
        "אחראי על כלל ההיבטים הטכנולוגיים והתהליכיים (או\"ש) בקבוצה בדגש על דיגיטל, דאטה וחדשנות עסקית.",
...

    {
      ...
      category: "retail",
      shortSummary: "הובלת טרנספורמציה דיגיטלית מלאה שהפכה את החברה ל-Data-Driven מבוססת AI/ML, ניהול כלל מערך התשתיות, פיתוח R&D, דאטה, eCommerce, הטמעת טכנולוגיית חיישני Nano BLE של Wiliot ברצפת המכירה, והרצאות מרכזיות בכנסים בינלאומיים.",
      bullets: [
...

    {
      ...
      bullets: [
        ...
        "ניהול תקציב של עשרות מיליוני ש\"ח, הובלת מו\"מ וחוזים מול ספקים גדולים."
      ],
...

    {
      ...
      bullets: [
        "ניהול יחידה עסקית מקצה לקצה, P&L, בהיקף מחזור מכירות של כ-20 מיליון ₪ בשנה.",
...

    {
      ...
      bullets: [
        ...
        "ניהול תקציב בהיקף של כ-30 מיליון ₪ וניהול מו\"מ מול חברות ענק כמו Oracle, HP, Microsoft וכו'.",
    ...
    education: [
      {
        ...
        details: "התמחות בניהול אסטרטגי, מימון, מנהיגות גלובלית וקבלת החלטות ברמת C-Level.",
        icon: "graduation-cap"
      },
      {
        period: "2004 - 2008",
        degree: "B.Sc בהנדסת תוכנה בהצטיינות (Summa Cum Laude)",
        institution: "מכללת שנקר - הפקולטה להנדסה",
        details: "לימודי הנדסת תוכנה, מבני נתונים, אלגוריתמיקה, ארכיטקטורה ומערכות מבוזרות.",
        icon: "award"
      }
    ],
    academicAndMentoring: [
      {
        ...
        details: "ליווי יזמים וסטארטאפים צעירים, שיפוט בתחרויות האקתונים ומיזמים, הרצאות אורח על טרנספורמציה דיגיטלית, AI ו-Retail Tech.",
        icon: "compass",
        links: [
          {
            url: "https://www.linkedin.com/feed/update/urn:li:activity:6958397301593640961/",
            title: "מנטורינג ושיפוט בתכניות יזמות באוניברסיטת רייכמן",
            desc: "הדרכת יזמים צעירים, פיתוח מודלים עסקיים וליווי טכנולוגי למיזמים.",
            source: "LinkedIn / Reichman",
            type: "social",
            badge: "Mentorship"
          },
          {
            url: "https://www.linkedin.com/feed/update/urn:li:activity:6732563324820623360/",
            title: "הרצאות והעברת ידע למנהלים וליזמים",
            desc: "חיבור בין הניסיון המעשי בארגוני ענק לבין האג'יליות והחדשנות של יזמים.",
            source: "LinkedIn",
            type: "social",
            badge: "Lecture"
          }
      ...
      },
      {
        ...
        institution: "מכללת שנקר - הפקולטה להנדסה",
        details: "הוראת יסודות מדעי המחשב, עקרונות תכנות ופתרון בעיות הנדסיות מורכבות לסטודנטים להנדסה.",
        icon: "book-open"
      }
    ]
  },
